...
public partial class @PlayerControls : IInputActionCollection2, IDisposable
{
    ...
    public struct PlayerActions
    {
        ...
        public void SetCallbacks(IPlayerActions instance)
        {
            ...
            {
                @NormalStroke.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnNormalStroke;
                @NormalStroke.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnNormalStroke;
                @NormalStroke.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnNormalStroke;
                @WideStroke.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnWideStroke;
                @WideStroke.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnWideStroke;
                @WideStroke.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnWideStroke;
                @SideStroke.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnSideStroke;
                @SideStroke.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnSideStroke;
                @SideStroke.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnSideStroke;
                @RudderAxis.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnRudderAxis;
                @RudderAxis.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnRudderAxis;
                @RudderAxis.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnRudderAxis;
                @EdgeAxis.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnEdgeAxis;
                @EdgeAxis.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnEdgeAxis;
                @EdgeAxis.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnEdgeAxis;
                @BackStroke.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnBackStroke;
                @BackStroke.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnBackStroke;
                @BackStroke.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnBackStroke;
    ...
    private IPlayerLandMovementActions m_PlayerLandMovementActionsCallbackInterface;
    private readonly InputAction m_PlayerLandMovement_Movement;
    public struct PlayerLandMovementActions
    {
        private @PlayerControls m_Wrapper;
        public PlayerLandMovementActions(@PlayerControls wrapper) { m_Wrapper = wrapper; }
        ...
        {
            if (m_Wrapper.m_PlayerLandMovementActionsCallbackInterface != null)
            {
                @Movement.started -= m_Wrapper.m_PlayerLandMovementActionsCallbackInterface.OnMovement;
                @Movement.performed -= m_Wrapper.m_PlayerLandMovementActionsCallbackInterface.OnMovement;
                @Movement.canceled -= m_Wrapper.m_PlayerLandMovementActionsCallbackInterface.OnMovement;
            }
            m_Wrapper.m_PlayerLandMovementActionsCallbackInterface = instance;
            if (instance != null)
            {
